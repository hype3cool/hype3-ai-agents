...
import PresaleBasicInfoBox from '../elements/PresaleBasicInfo';
        ...
        <div className="relative">
            <TabGroup selectedIndex={selectedIndex} onChange={setSelectedIndex} className="absolute w-full">
                <div ref={headerRef} className="fixed z-50 w-full bg-black">
                    <PresaleBasicInfoBox data={data} onHeaderHeightChange={handleHeaderHeightChange} headerRef={headerRef} />
