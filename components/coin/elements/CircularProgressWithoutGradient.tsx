...
interface CircularProgressWithoutGradientProps {
    progress: number; // Progress percentage (0-100+)
    size?: number; // Size of the circular progress bar in pixels
    strokeWidth?: number; // Width of the progress bar stroke
}

const CircularProgressWithoutGradient: React.FC<CircularProgressWithoutGradientProps> = ({ progress, size = 100, strokeWidth = 8 }) => {
...
export default CircularProgressWithoutGradient;